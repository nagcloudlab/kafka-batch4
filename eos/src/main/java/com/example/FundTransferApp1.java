...
// using kafka consumer Api & producer Api


public class FundTransferApp1 {
...
//                        }
                        ...
                        consumer.commitSync(offsets); // commit the offset request consumer-group-coordinator
                        // Commit the transaction
                        producer.commitTransaction(); // commit the transaction to the transaction coordinator
                        System.out.println("Transaction committed successfully for: " + record.value());
                    } catch (Exception e) {
                        producer.abortTransaction(); // abort the transaction
