...
// Toppology
// source,stream & sink processor

public class FundTransferApp2 {
    ...
    public static void main(String[] args) {
        ...
        KStream<String, String> transfersStream = builder.stream("trans*"); // source processor
        ...
        branchedStreams[0]
                .to("balances", Produced.with(Serdes.String(), Serdes.String()));
